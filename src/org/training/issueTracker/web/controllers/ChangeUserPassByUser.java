...
/**
 * Servlet implementation class changeUserPassByUser
 */
@WebServlet("/ChangeUserPassByUser")
public class ChangeUserPassByUser extends HttpServlet {
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		System.out.println("Hello from  changeUserPassByUser///////////////////////////////////////////////////////");
